...
CreateConVar("mcs_sv_enable_by_default", 1, fcvarFlags, "Whether players have MCS1 enabled by default when they join.", 0, 1)
CreateConVar("mcs_sv_force", 1, fcvarFlags, "Prevent players from being able to change whether MCS1 is enabled for them.", 0, 1)
...
CreateConVar("mcs_sv_hud_enable_by_default", 1, fcvarFlags, "Whether the MCS1 hud is enabled by default for users.", 0, 1)
CreateConVar("mcs_sv_hud_show_health_armor_by_default", 1, fcvarFlags, "Whether the MCS1 hud shows health and armor by default.", 0, 1)
